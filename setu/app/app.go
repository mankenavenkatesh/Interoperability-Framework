...
import (
	...
	setumodule "setu/x/setu"
	setumodulekeeper "setu/x/setu/keeper"
	setumoduletypes "setu/x/setu/types"
...
type App struct {
	*baseapp.BaseApp
	...
	SetuKeeper setumodulekeeper.Keeper
...
func New(
	...
	app.SetuKeeper = *setumodulekeeper.NewKeeper(
		appCodec,
		keys[setumoduletypes.StoreKey],
		keys[setumoduletypes.MemStoreKey],
		app.GetSubspace(setumoduletypes.ModuleName),
	)
	setuModule := setumodule.NewAppModule(appCodec, app.SetuKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(setumoduletypes.ModuleName)
